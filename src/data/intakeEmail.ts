...
//
// DELIBERATELY VAGUE ABOUT HOURS. A number quoted to a candidate in writing is
// a number they will hold us to, and the hour figures are program-design
// targets that move whenever the schedule is rebuilt against the course text.
// These emails describe the shape of the program — how long it runs, where it
